...
#G = nx.read_graphml('./data/graphs/bipartite_graph.graphml') # Korean language graph
...
synonyms = None
#with open('./data/synonym/korean_synonyms.csv') as f:
with open('./data/synonym/chinese_synonyms.csv') as f:
    rd = csv.reader(f)
    synonyms = list(rd)
